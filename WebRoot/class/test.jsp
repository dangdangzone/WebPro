...
<html>
	...
	<body>
		页面一:
		<!-- 
		<video src="/movie/movie.mp4" controls="controls"></video>

		<OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
			codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0"
			WIDTH="550" HEIGHT="400" id="myMovieName">
			<PARAM NAME=movie VALUE="/movie/04.swf">
			<PARAM NAME=quality VALUE=high>
			<PARAM NAME=bgcolor VALUE=#FFFFFF>
			<EMBED src="/movie/04.swf" quality=high bgcolor=#FFFFFF WIDTH="550"
		...
		<script type="text/javascript">
			...
			swfobject.embedSWF('/pub/ckplayer/ckplayer.swf', 'a1', '600', '400', '10.0.0','/pub/ckplayer/expressInstall.swf', flashvars, params, attributes); //播放器地址，容器id，宽，高，需要flash插件的版本，flashvars,params,attributes 
		</script>
	</body>
</html>